---
title: Generate open graph images on the edge with Netlify edge functions in Astro
imageAlt: "The logo of Astro and Netlify"
pubDate: 2022-11-05
heroImage: "astro_netlify_hero.png"
description: In this guide, you will learn how to generate open graph images on the edge with Netlify in Astro.
---
...
<BlogImage src={import("../../images/blank-og.png")} alt="Blank example of an og image" />

## Creativity is the limit

From this point forward, you can customize the image to your liking. Feel free add additional query parameters, change the styling, add additional components, anything you can think of.

If you are in need of inspiration, here is the open graph image I generated for this post.

<BlogImage src={import("../../images/example-og.png")} alt="OG image for this blog post" />
